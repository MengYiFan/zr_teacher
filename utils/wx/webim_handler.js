...
function onMsgNotify(newMsgList) {
  console.warn('webimhandler.onMsgNotify newMsgList:', newMsgList)
  var newMsg;
...
function onRevokeGroupNotify(notify) {
  console.warn('onRevokeGroupNotify@', notify)
...
function onGroupInfoChangeNotify(groupInfo) {
  console.warn('webimhandler.onGroupInfoChangeNotify onGroupInfoChangeNotify@', groupInfo)
